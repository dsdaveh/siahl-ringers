...
season_name <- "2023_winter"
#season_name <- "Current"
players_file <- sprintf("players_stats-%s.RDS", season_name)
...
goal_diff_plt <- worst_case_season %>% 
    ...
    ggtitle("Change in goal differential w ringer influenced goals  removed",
            subtitle = "(Arrows touching/passing through 0 affect Standings points)") +
    xlab("")
goal_diff_plt
```
