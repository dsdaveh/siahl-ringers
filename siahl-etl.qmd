...
```{r}
player_file = sprintf("player_stats-%s.RDS", season)
games_file = sprintf("games_stats-%s.RDS", season)
saveRDS(players, file = here('data', player_file))
saveRDS(all_games, file = here('data', games_file))
saveRDS(seasons, file = here('data', season_file))
saveRDS(game_tables, file = here('data', game_tables_file))
```
