...
for (igame in 1:nrow(worst_case_games)) {
    ...
    game_refactored <- dfrow %>% 
        ...
        mutate(goal_diff = goals_for - goals_against,
               ...
               `Game/ID` = sprintf("%s vs %s", str_extract(Game, '\\d+'), Opponent))
