...
season_name <- "Current"
players_file <- here('data', sprintf("player_stats-%s.RDS", season_name))
games_stats_file <- here('data', sprintf("games_stats-%s.RDS", season_name))
scorecards_file <- here('data', sprintf("games_tables-%s.RDS", season_name))
...
games_adj_file <- here('data', sprintf("games_adj-%s.RDS", season_name))
