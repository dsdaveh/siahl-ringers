...
home_away_nudge = 0.1
geom_home_arrow <- function(...) {
    geom_segment(..., aes(y = Game + home_away_nudge, yend = Game + home_away_nudge ,
                          x = goals_for, xend = adj_goals_for),
                 arrow = arrow(ends = "last", angle = 20))
}
...
wcl_rank %>% 
    ...
    scale_color_manual(values = c("drop" = "darkred", "rise" = "skyblue", "same" = "gray")) +
